...
public class CadastrarUsuarioUseCase {
    ...
    public ResponseEntity<UsuarioCadastradoResponseDTO> cadastrar(UsuarioCadastradoRequestDTO dto) {
        validarEntradas(dto);
    ...
    private UsuarioEntity criarUsuario(UsuarioCadastradoRequestDTO dto, RoleEntity role) {
    ...
    private void validarEntradas(UsuarioCadastradoRequestDTO dto) {
